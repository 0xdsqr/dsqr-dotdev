  ...
  return (
    <>
      ...
      <div className="flex flex-1 flex-col gap-6 p-6">
        <div>
          <h1 className="text-xl font-semibold tracking-tight">Virtual Machines</h1>
          <p className="text-sm text-muted-foreground mt-1">Dell R730xd &middot; Proxmox VE</p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-4">
          <SummaryCard
            ...
            sub="running"
          />
          <SummaryCard icon={Cpu} label="Total vCPUs" value={`${totalCores}`} sub="allocated" />
          <SummaryCard
            icon={MemoryStick}
            label="Total RAM"
              ...
              {vms.map((vm) => {
                ...
                return (
                  <TableRow key={vm.vmid}>
                    ...
                    <TableCell className="text-muted-foreground">{vm.node}</TableCell>
                    <TableCell className="text-right font-mono">{vm.cores}</TableCell>
                    <TableCell className="text-right font-mono">
                      {formatMemory(vm.memoryMB)}
                    </TableCell>
                    <TableCell className="text-right font-mono">{vm.diskGB} GB</TableCell>
