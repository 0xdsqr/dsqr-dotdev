...
import { Activity, ArrowRight, FileText, Newspaper, PenLine, Plus, Server } from "lucide-react"
      ...
      <div className="flex flex-1 flex-col gap-6 p-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Your personal studio for content, homelab, and everything in between.
          </p>
        </div>
...
function ModuleCard({
  ...
  return <div className="rounded-xl border bg-card p-5 opacity-60">{content}</div>
}
