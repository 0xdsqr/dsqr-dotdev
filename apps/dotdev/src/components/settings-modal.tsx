...
import {
  ...
  DialogDescription,
  DialogTitle,
} from "@dsqr-dotdev/react/components/ui/dialog"
...
interface SettingsModalProps {
  ...
  username?: string
  avatarUrl?: string
  onSave?: (data: { username: string; avatarUrl?: string }) => void | Promise<void>
}
        ...
        <div className="flex flex-col h-screen max-h-[80vh]">
          <div className="flex items-center justify-between border-b border-border p-6">
            <div>
              ...
              <p className="text-xs text-muted-foreground font-mono mt-1">manage your account</p>
            </div>
          </div>
